 ...
 */
export declare function createM2RApi<T extends IPCManifest>(manifest: T, channel?: string): {
    manifest: T;
    /**
 ...
 * @param channel the channel to use, default to "ipc-basic-channel"
 */
export declare function createR2MApi<T extends IPCManifest>(manifest: T, channel?: string): {
    manifest: T;
